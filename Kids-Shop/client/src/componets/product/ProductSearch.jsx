...
export default function ProductSearch ({setProduct, listProduct}) {
                    ...
                    <div className="product-thumb" key={index} style={{width: "33.33%", float:"left"}}>
                      <div className="item">
                        <div className="product-desc">
                          <div className="product-title"><a >{product?.name}</a></div>
          ...
          <div id="new-products-block" className="tab-pane">
            <div className="block_content row">
              ...
              <div className="product-thumb">
                  <div className="item">
                    <div className="product-desc">
                      <div className="product-title"><a >Aroma Mocha</a></div>
                      <div className="product-comments">  
                        <div className="star_content">
                            <div className="star star_on"></div>
                            <div className="star star_on"></div>
                    ...
                    <div className="image">
                      <a  className="thumbnail product-thumbnail">
